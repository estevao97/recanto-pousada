        ...
        <div className="cartao1">
         ...
         "
          ...
          <CardAtrações
            ...
            apresentacao="Uma adrenalina e tanto, para quem tem coragem! E gosta de se aventurar nas alturas"
        ...
        Esta embarcação começou a ficar famosa a partir da década de 1970, criada na Groenlândia
         ...
         "
          ...
          <CardAtrações
            title="Asa Delta"
            title2="Asa Delta"
            image="https://images.pexels.com/photos/53012/glider-hang-glider-pilot-flying-53012.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
            apresentacao="A Asa delta é muito deasfiadora, quem gosta de se sentir nas alturas vai amar nossa atração!"
            detalhamento="A asa delta é uma das modalidades mais famosas de esportes radicais praticados no ar que existem, 
         principalmente em cidades com montanhas ou terrenos propícios para os voos.
         Assim, para pode voar de asa delta não é necessário o uso de aviões para o transporte dos praticantes até o céu.
         Uma vez que o salto é realizado, os atletas podem voar de forma indefinida, desde que haja raios solares suficientes 
         ...
         "
          ...
          <CardAtrações
            title="Pescaria"
            title2="Pescaria"
            image="https://images.pexels.com/photos/1143926/pexels-photo-1143926.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
            apresentacao="A pescaria é nossa atração para aquelas pessoas que pretendem relaxar,venham conferir!"
            detalhamento="Saber aproveitar tudo o que a atividade envolve, também faz bem para quem pratica a mesma, 
            como curtir o sol, o verde, o vento, o som dos pássaros, das águas e aprender um pouco mais sobre os tipos de peixes e a 
            respeito da natureza. Além disso, é importante destacar que, quem pesca, exercita a paciência e autoconfiança. A paciência, 
            porque é preciso aguardar até o momento em que o peixe é fisgado pela isca. E, a autoconfiança, porque o indivíduo irá aguçar a 
            vontade de superar cada vez mais os próprios limites.
            O exercício da pesca, também traz ao praticante, a oportunidade de conhecer pessoas, fazer novos amigos e até companheiros de pesca. 
            Isso faz com que o indivíduo possa interagir, contar histórias e dividir experiências.
         "
          />
        </div>
      </div>
