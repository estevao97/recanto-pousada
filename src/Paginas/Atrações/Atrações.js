    ...
    <div className="baseatracoes">
      <div className="container-atracoes">
          ...
          <div className="coluna1">
            ...
            <div className="cardatracao">
              ...
              <div className="texto2">
                O kaik é uma atração para quem adora sentir aquele frio na
                barriga, é muito desafiante e restaurador de energias
                hdajsdjshdjsahdasjd hsadghsdsadg
                <br></br>
            ...
            <div className="cardatracao">
              ...
              <div className="texto3">
                A asa delta é uma ótima atração para quem quer se sentir nas
                alturas!<br></br> Venha conferir esta novidade!! <br></br> Valor
                por pessoa: R$100,00;
              </div>
            </div>
          </div>
          <div className="coluna2">
            <div className="cardatracao">
              ...
              <div className="texto4">
                A pescaria é uma boa opção para quem gosta de ficar em paz e
                relaxar<br></br>Valor por pessoa: Grátis,apenas paga pelo valor
                do pescado.
              </div>
            </div>
            ...
            <div className="cardatracao">
              ...
              <div className="texto5">
                O misto de medo antes de pular e a liberdade de se sentir quase
                voando! Essa é a sensação que quem se <br></br>aventura em nossa
                tirolesa costuma contar.
            ...
            <div className="cardatracao">
              ...
              <div className="texto6">
                Temos nosso passeio a cavalo, todos costumam adorar!<br></br>
                Venha conferir!<br></br>
        ...
        <footer class="kb-footer">
          <div class="kb-footer-wrapper templete centered"></div>
        </footer>
      </div>
    </div>
  );
